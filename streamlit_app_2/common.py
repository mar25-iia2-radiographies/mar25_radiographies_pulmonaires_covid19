...
# pandas sert à créer les tableaux affichés dans Streamlit.
import pandas as pd

# streamlit sert à afficher les titres, textes, images, tableaux, etc.
import streamlit as st

# pathlib permet de construire des chemins de fichiers compatibles Linux, Windows et Mac.
from pathlib import Path

# hashlib permet de créer une petite signature d'un fichier chargé par l'utilisateur.
import hashlib

# numpy sert pour le prétraitement des images et la manipulation de tableaux numériques.
import numpy as np

# PIL permet d'ouvrir, convertir et redimensionner les images chargées.
...
def page_header(icon, title, caption=None):
    """
    Affiche un en-tête identique sur toutes les pages.

    Paramètres :
    - icon : icône affichée avant le titre.
    - title : titre principal de la page.
    - caption : petit texte optionnel sous le titre.

    Cette fonction évite de recopier les mêmes lignes Streamlit dans chaque page.
    """
